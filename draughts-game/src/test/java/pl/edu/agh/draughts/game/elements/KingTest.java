...
public class KingTest extends ParameterTest {
	...
	@Test
	public void testGetCapturePositions() {
		...
		List<ChessboardPosition> chessboardPositions = chessboardTable[6][6]
				.getCapturePositions(6, 6, draughtsEngine.getChessboard());
		assertEquals(chessboardPositions.size(), 2);
	}
